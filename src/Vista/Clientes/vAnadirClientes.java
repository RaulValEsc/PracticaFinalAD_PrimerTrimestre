 ...
 * @author PC
 */
public class vAnadirClientes extends javax.swing.JDialog {

    ControladorClientes ctrl = new ControladorClientes();
    
    DefaultTableModel modelo;
    /**
     * Creates new form vAnadirClientes
     */
    public vAnadirClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        modelo = (DefaultTableModel) tAnadirClientes.getModel();
        rellenarTabla();
    }
    ...
    private void initComponents() {
        ...
        tAnadirClientes = new javax.swing.JTable();
        ...
        tAnadirClientes.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tAnadirClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tAnadirClientes.setRowSelectionAllowed(false);
        tAnadirClientes.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tAnadirClientes);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vAnadirClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vAnadirClientes dialog = new vAnadirClientes(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tAnadirClientes;
